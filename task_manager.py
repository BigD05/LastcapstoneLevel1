...
def add_task():
    task_user = input("please insert the name of the user that the task is assigned to: ")
    if task_user not in user_names:
        ...
        assigned_date = input("please insert date e.g 10 Oct 2019: ")
        due_date = input("please insert due date e.g 12 Oct 2019: ")
        completed = ("No")
...
The user {usr_check} has total tasks of: {user_count}
